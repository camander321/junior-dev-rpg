export class Terminal {
	...
	promptInput(terminalObj, message, PROMPT_TYPE, callback) {
		var shouldDisplayInput = (PROMPT_TYPE === 1);
		...
		if (message.length) terminalObj.print(PROMPT_TYPE === 3 ? message + ' (y/n)' : message);
  ...
  constructor(id) {
    ...
    this.password = function (message, callback) {
      this.promptInput(this, message, 2, callback);
    };

    this.confirm = function (message, callback) {
      this.promptInput(this, message, 3, callback);
    };
